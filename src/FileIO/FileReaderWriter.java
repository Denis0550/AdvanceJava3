...
public class FileReaderWriter {
    public static void main(String[] args) throws IOException {
        ...
        fw=new FileWriter("C:\\Users\\dsoro\\Downloads\\FileRW.txt",true);//write more
        ...
        /*FileReader fr = new FileReader("C:\\Users\\dsoro\\Downloads\\FileRW.txt");
        int i;
        while((i=fr.read()) != -1){
...
String separator = File.separator;
String home = System.getProperty( "user.home" );
//System.out.println(home);//incase you need to know where is your Home!
String fileName ="FileRW.txt";
FileWriter fw = new FileWriter(home + separator + fileName);
fw.write("Hey! Whats Up... This is written with FileWriter!");
fw.close();
